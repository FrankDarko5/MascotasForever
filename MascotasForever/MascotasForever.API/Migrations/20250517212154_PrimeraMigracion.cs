    ...
    public partial class PrimeraMigracion : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdProductoCita = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdCita = table.Column<int>(type: "int", nullable: false),
                    IdProducto = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductosCitas", x => x.IdProductoCita);
                    table.ForeignKey(
                        name: "FK_ProductosCitas_Citas_IdCita",
                        column: x => x.IdCita,
                        principalTable: "Citas",
                        principalColumn: "IdCita",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductosCitas_Productos_IdProducto",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductosCitas_IdCita",
                table: "ProductosCitas",
                column: "IdCita");

            migrationBuilder.CreateIndex(
                name: "IX_ProductosCitas_IdProducto",
                table: "ProductosCitas",
                column: "IdProducto");
        }
